 ...
 * generated in the itemservice.gen package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetItemResponse_QNAME = new QName("http://semesterarbeit2.wi.mbg.de/", "getItemResponse");
    private final static QName _GetItem_QNAME = new QName("http://semesterarbeit2.wi.mbg.de/", "getItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: itemservice.gen
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://semesterarbeit2.wi.mbg.de/", name = "getItemResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://semesterarbeit2.wi.mbg.de/", name = "getItem")
